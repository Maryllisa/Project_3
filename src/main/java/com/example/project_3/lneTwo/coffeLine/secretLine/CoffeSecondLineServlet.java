...
@WebServlet(name = "coffeSecondLine", value = "/coffeSecondLine")
public class CoffeSecondLineServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (option.equals("yes")) {
            strJSPPath = "lineTwo/coffeLine/coffeLineSecondBranch/endFive.jsp";
            ...
            strJSPPath = "lineTwo/coffeLine/coffeLineSecondBranch/endFour.jsp";
            session.setAttribute("time", 100);
            this.countEnd = (int) session.getAttribute("countEnd");
            session.setAttribute("countEnd", --this.countEnd);
