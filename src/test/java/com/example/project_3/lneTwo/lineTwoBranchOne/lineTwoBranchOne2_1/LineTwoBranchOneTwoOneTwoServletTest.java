...
class LineTwoBranchOneTwoOneTwoServletTest {
    ...
    HttpSession session;
    @Mock
    LineTwoBranchOneTwoOneTwoServlet lineTwoBranchOneTwoOneTwoServlet;
    @BeforeEach
    void setUp() {
        MockitoAnnotations.initMocks(this);
        this.lineTwoBranchOneTwoOneTwoServlet = new LineTwoBranchOneTwoOneTwoServlet();
    }
    @Test
    void doPostYes() throws ServletException, IOException {
        ...
        lineTwoBranchOneTwoOneTwoServlet.doPost(req,resp);
        ...
        verify(req).getRequestDispatcher("lineTwo/lineOne-BranchOne/LineTwo-BranchOne-2_1/endEight.jsp");
    ...
    void doPostNo() throws ServletException, IOException {
        ...
        verify(session).setAttribute("time", 100);
        verify(session).setAttribute("countEnd", 7);
        verify(req).getRequestDispatcher("lineTwo/lineOne-BranchOne/LineTwo-BranchOne-2_1/endSeven.jsp");
        verify(disp).forward(req, resp);
