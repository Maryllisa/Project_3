...
class LineTwoBranchOneServletTest {
    ...
    HttpSession session;
    @Mock
    LineTwoBranchOneServlet lineTwoBranchOneServlet;
    @BeforeEach
    void setUp() {
        MockitoAnnotations.initMocks(this);
        this.lineTwoBranchOneServlet = new LineTwoBranchOneServlet();
    }
    @Test
    void doPostYesOne() throws ServletException, IOException {
        ...
        lineTwoBranchOneServlet.doPost(req,resp);
